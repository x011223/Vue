			...
			<div class="add-bottom">
				...
				<div class="history" v-show="!inputText">
					<div class="history-text">
						<h3
							class="play-title"
							:class="{'active': showplayHistory === true}"
							@click.stop="playhistoryShow"
						>播放记录</h3>
						<h3
							class="search-title"
							:class="{'active': showSearchHistory === true}"
							@click.stop="searchhistoryShow"
						>搜索记录</h3>
					</div>
					<scroll
...
<style lang="scss" scoped>
	...
	.add_song-enter-active,
	.add_song-leave-active {
